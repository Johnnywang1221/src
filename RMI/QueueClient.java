...
public class QueueClient {
	...
	public static void main(String[] argv) {
		...
		try {
			QueueInterface queue = (QueueInterface) Naming
					.lookup("rmi://10.108.107.92:1099/Queue");
			byte[] content = QueuePutter.image2bytes("resource/pic/ST_1403143732342.jpg");
			String json = EXIFParser.parse(content);
			
			for(int i = 0;i<10;i++){
				System.out.println(queue.insert(DataType.PIC,json.getBytes(),"resource/pic/7.pic".getBytes()));
				Thread.sleep(100);
			}
